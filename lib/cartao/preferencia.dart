...
import 'package:pix_99freelas/cartao/pagamento_cartao.dart';
import 'package:pix_99freelas/pix/dados_pix.dart';
...
class _TelaCriaPIXState extends State<TelaGeraPreferencia> {
  ...
  Future<void> gerarPreferencia() async{
    ...
    var url = Uri.parse('http://localhost:8080/transacao_pix/api/gerar_preferencia');
